...
import { Box, Button, CircularProgress, Stack, ToggleButton, Typography } from '@mui/material';
				...
				<Stack spacing={2} direction="row">
					...
					<Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
						...
						<Typography className={styles.description} sx={{ my: 1 }}>
							<b>Max gain</b>: <span className={styles.profit}>${longDepositAmount * 10}</span> if SOL/USD is{' '}
							<span className={styles.highlight}>above $15.65</span> <MomentTooltipSpan datetime={settleStart} />
						</Typography>
						<Typography className={styles.description} sx={{ my: 1 }}>
